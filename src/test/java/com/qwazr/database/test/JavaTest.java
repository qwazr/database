...
public class JavaTest {
  ...
  private TableRequestResult checkResult(final AnnotatedTableService<JavaRecord> service, final TableQuery.Group query,
          final Long expectedCount, final JavaRecord... rows) {
  ...
  public void test400FilterQuery() throws URISyntaxException {
    ...
    checkResult(service,
            new TableQuery.Or().add(JavaRecord.COL_DPT, ROW3.dpt.get(0)).add(JavaRecord.COL_DPT, ROW2.dpt.get(0)), 2L,
            ROW2, ROW3);
  }
