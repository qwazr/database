...
import com.qwazr.database.store.ByteConverter.StringByteConverter;
...
public class ColumnIndexesKey<T> extends KeysAbstract<T> {
	...
	private ByteConverter<T> byteConverter;

	protected ArrayIterator(ByteConverter<T> byteConverter) {
