...
final public class ColumnDefKey extends KeyAbstract<InternalColumnDefinition> {

	private final byte[] fieldBytes;

	static final ByteConverter.JsonByteConverter<InternalColumnDefinition> columnInternalDefinitionByteConverter =
			new ByteConverter.JsonByteConverter<>(InternalColumnDefinition.class);
